...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.icons = {
			leftArrow: this.fontAwesome ? 'fa-arrow-left' : (this.bootcssVer === 3 ? 'glyphicon glyphicon-arrow-left' : 'glyphicon glyphicon-arrow-left'),
			rightArrow: this.fontAwesome ? 'fa-arrow-right' : (this.bootcssVer === 3 ? 'glyphicon glyphicon-arrow-right' : 'glyphicon glyphicon-arrow-right')
		};
